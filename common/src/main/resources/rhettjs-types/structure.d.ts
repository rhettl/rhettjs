...
declare module 'rhettjs/structure' {
    ...
    export const StructureNbt: {
         ...
         */
        load(name: string): Promise<StructureData>;
         ...
         */
        save(name: string, data: StructureData): Promise<void>;
         ...
         */
        listGenerated(namespace?: string): Promise<string[]>;
         ...
         */
        capture(pos1: Position, pos2: Position, name: string, options?: CaptureOptions): Promise<void>;
         ...
         */
        place(position: Position, name: string, options?: PlaceOptions): Promise<void>;
         ...
         */
        getSize(name: string): Promise<{ x: number; y: number; z: number }>;
         ...
         */
        blocksList(name: string): Promise<Record<string, number>>;
         ...
         */
        blocksNamespaces(name: string): Promise<string[]>;
         ...
         * });
         */
        blocksReplace(name: string, replacementMap: Record<string, string>): Promise<void>;
         ...
         */
        listBackups(name: string): Promise<string[]>;
         ...
         */
        restoreBackup(name: string, timestamp?: string): Promise<void>;
    };
     ...
     * );
     */
    export const LargeStructureNbt: {
        /**
         ...
         * );
         */
        capture(pos1: Position, pos2: Position, name: string, options?: CaptureLargeOptions): Promise<void>;
